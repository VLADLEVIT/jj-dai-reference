...
`JJ_DAI_Roadmap_r6_8_5.md` is canonical; the PDF is the same document typeset
...
or r6.8.4 is not required to read r6.8.5. The changes tables at the top are the delta.
